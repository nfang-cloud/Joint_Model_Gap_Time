...
############################Import the Estimation######################
 ...
 betaz=list(est$betax5,est$betax5)
 betax=list(c(est$betax1,est$betax2,est$betax3,est$betax4,est$betaz),
            c(est$betax1,est$betax2,est$betax3,est$betax4,est$betaz))
...
#######################est1 from the real Estimates###############
 ...
 Bbetaz=list(Best[22],Best[22])
 Bbetax=list(Best[c(18:21,17)],Best[c(18:21,17)])
 Betaz=Best[28]
 Betax=Best[c(24:27,23)]
 Bdelta1=Best[30]
 Bdelta2=0
 Betam=Best[29]
 ...
 write.csv(Bres1_new,paste("Bres_Gap_CD4",as.character(1111+simseed),"batch=",as.character(batch),".csv",sep=""),row.names=FALSE)
}
}
