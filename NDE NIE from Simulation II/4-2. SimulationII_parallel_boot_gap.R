...
####read in estimated variance #simseed (please finish)

estvar=read.table(paste("covIIgap",as.character(simseed+1),".txt",sep=""),header=FALSE,row.names=1,na.strings = ".")
...
write.csv(myBest,paste("Boot2_gaplres",as.character(simseed+1),"batch=", as.character(bootbatch),".csv",sep=""),row.names=FALSE)
